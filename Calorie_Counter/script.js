...
**You also need to clear the output element's text.
You can do this by setting the innerText property to an empty string.
...
The classList property has an .add() method which is the opposite of the
